...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // biome-ignore lint/suspicious/noDocumentCookie: code generated by shadcn/ui
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        // Collapsed to the icon rail the label is hidden by pulling it a full row
        // up and fading it out — which leaves it lying over the row above,
        // still hit-testable. Without this it swallows that row's hover and
        // the icon under it silently loses its tooltip.
